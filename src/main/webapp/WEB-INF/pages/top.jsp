...
<head>
    <meta charset="utf-8">
    <title> OA系统--欢迎使用OA系统 </title>
    <link rel="stylesheet" type="text/css" href="/assets/skin/default_skin/css/theme.css">
    <link rel="stylesheet" type="text/css" href="/assets/admin-tools/admin-forms/css/admin-forms.css">
    <link rel="stylesheet" type="text/css" href="/vendor/plugins/datepicker/css/bootstrap-datepicker.css">
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown menu-merge">
                <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown">
                    <img src="/avatars/${sessionScope.employee.imgUrl}" alt="avatar" class="mw30 br64">
    ...
    <aside id="sidebar_left" class="nano nano-light affix">
        <div class="sidebar-left-content nano-content">
                ...
                <div class="sidebar-widget author-widget">
                    <div class="media">
                        <a class="media-left" href="#">
                            <img src="/avatars/${sessionScope.employee.imgUrl}" class="img-responsive">
                        </a>
            ...
            <ul class="nav sidebar-menu">
                ...
                <c:if test="${sessionScope.employee.post == Contant.POST_GM || sessionScope.employee.post == Contant.POST_AM || sessionScope.employee.post == Contant.POST_FM}">
                    <li>
                        <a href="/inform/list">
                            <span class="glyphicon glyphicon-home"></span>
                            <span class="sidebar-title">通知管理</span>
                        </a>
                    </li>
                </c:if>
                <c:if test="${sessionScope.employee.post == Contant.POST_TEACHER || sessionScope.employee.post == Contant.POST_CASHIER || sessionScope.employee.post == Contant.POST_STAFF}">
                    <li>
                        <a href="/list">
                            <span class="glyphicon glyphicon-home"></span>
                            <span class="sidebar-title">查看通知</span>
                        </a>
                    </li>
                </c:if>
                <li>
