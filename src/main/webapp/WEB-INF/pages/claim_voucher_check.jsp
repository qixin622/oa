            ...
            <div class="panel heading-border">
                <div class="panel-body bg-light">
                    ...
                    <div class="section row">
                        ...
                        <div class="col-md-3">费用项目：${item.item}</div>
                        <div class="col-md-3">费用金额：${item.amount}</div>
                        <div class="col-md-5">费用说明：${item.comment}</div>
                        </c:forEach>
                    </div>
                    <div class="section row">
                    ...
                    <c:forEach items="${records}" var="record">
                        <div class="col-md-2">处理人：${record.dealer.name}</div>
                        <div class="col-md-3">处理时间：<spring:eval expression="record.dealTime"/></div>
                        <div class="col-md-2">处理方式：${record.dealWay}</div>
                    ...
                    <form:form id="admin-form" name="addForm" action="/claim_voucher/check" modelAttribute="record">
                        ...
                        <div class="panel-body bg-light">
                            ...
                            <div class="panel-footer text-right">
                                <c:if test="${sessionScope.employee.post==Contant.POST_FM || sessionScope.employee.post==Contant.POST_AM || sessionScope.employee.post==Contant.POST_GM}">
