...
import cn.edu.huat.oa.dto.ClaimVoucherInfo;
...
public class ClaimVoucherController {
    ...
    @RequestMapping("/self")
    public String self(@RequestParam(value = "pn", defaultValue = "1") Integer pn,
                       HttpSession session, Map<String,Object> map){
        Employee employee = (Employee)session.getAttribute("employee");
        PageHelper.startPage(pn, 5);
        PageInfo page = new PageInfo(claimVoucherBiz.getForSelf(employee.getSn()));
        map.put("pageInfo", page);
        return "claim_voucher_self";
    }
    @RequestMapping("/deal")
    public String deal(@RequestParam(value = "pn", defaultValue = "1") Integer pn,
                       HttpSession session, Map<String,Object> map){
        Employee employee = (Employee)session.getAttribute("employee");
        PageHelper.startPage(pn, 5);
        PageInfo page = new PageInfo(claimVoucherBiz.getForDeal(employee.getSn()));
        map.put("pageInfo", page);
